...
### What you can build
- **Hosted UI** via a single `uiHandle` (iframe or redirect)
- **Inline UI modules**: **FaceMatch** and **Document Capture**
- **API-only** integrations using thin **service clients** (AML, Phone, Payments, QES, KYB*)
...
3. **Run the flow**: 
   - either embed the Hosted UI (iframe/redirect) or mount UI modules (FaceMatch / Document Capture).
