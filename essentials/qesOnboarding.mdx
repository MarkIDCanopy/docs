...
| documentToSignTemplateUrl | string | Yes    | URL of PDF to sign. Must be accessible online over **HTTPS** and publicly reachable. Verify that the URL does not require authentication or headers to load. |
